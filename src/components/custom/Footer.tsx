...
const Footer = () => {
    return (<footer className="bg-white rounded-lg mt-4">
        <div className="w-full mx-auto container py-4 md:py-8">
            <div className="sm:flex sm:items-center sm:justify-between">
                ...
                <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                    <li>
                        <Link href="#" className="hover:underline me-4 md:me-6">Careers</Link>
                    </li>
                    <li>
            ...
            <span className="block text-sm text-gray-500 sm:text-center">© {new Date().getFullYear()} <Link href="/" className="hover:underline">Round Pizza™</Link>. All Rights Reserved.</span>
        </div>
    </footer>
