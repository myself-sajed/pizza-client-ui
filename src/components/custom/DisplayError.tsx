...
const DisplayError = ({ title, className = "" }: { title: string, className?: string }) => {
    return (
        <div className={cn('w-full h-full flex flex-col gap-3 items-center justify-center animate-fade', className)}>
            <svg className="grayscale opacity-75" width="93" height="23" viewBox="0 0 93 23" fill="none" xmlns="http://www.w3.org/2000/svg">
